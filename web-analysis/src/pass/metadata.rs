...
use html_ast::{AttributeMap, Fragment, Node, TagBuf};
...
pub struct OgMetadata {
    ...
    ///
    /// Example: `<meta property="og:url" content="https://example.com/roofing">`
    pub url: Option<String>,

    /// `<meta property="og:site_name">` — the name of the site or brand.
    ///
    /// Example: `<meta property="og:site_name" content="Superior Construction">`
    ...
    ///
    /// Example: `<meta property="og:image" content="https://example.com/preview.jpg">`
...
pub struct TwitterMetadata {
    ...
    ///
    /// Example: <meta name="twitter:site" content="@business-name">
